...
func TestPull(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedErrorText:   "secret object test2 does not exist in namespace test-namespace",
		},
		{
			secretName:          "",
			secretNamespace:     "test-namespace",
	...
	for _, testCase := range testCases {
		...
		testSecret := generateSecret(testCase.secretName, testCase.secretNamespace)
		...
		builderResult, err := Pull(testSettings, testSecret.Name, testSecret.Namespace)
